...
function Movie(props) {
  ...
  var handleClickAddMovieParent =()=>{
    if(likeMovie===false){
      props.handleClickParent(props.movieName,props.movieImg);}
    else {
  ...
  return (
    ...
    <CardBody>
        <p>Like <FontAwesomeIcon style={colorLike} icon={faHeart} onClick={() => handleClickAddMovieParent()} /* setLikeMovie(!likeMovie)} *//></p>
